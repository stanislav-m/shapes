#ifndef _var_shapes_h_
#define _var_shapes_h_

#include "common.h"
#include <variant>

namespace var_shapes {
...
class shape {
    public:
        ...
        void do_draw() const {  std::visit(draw_visitor{}, _data);  }
        double do_perimeter() const {  return std::visit(perimeter_visitor{}, _data); }
        double do_area() const { return std::visit(area_visitor{}, _data); }

    private:
        std::variant<circle, rectangle, triangle> _data;
};
